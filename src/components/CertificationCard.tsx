...
export const CertificationCard = ({ cert }: { cert: any }) => {
  return (
    <div className='flex flex-col sm:flex-row gap-6 rounded-2xl border border-neutral-700 p-5 bg-background hover:bg-zinc-900 transition-all duration-300 h-full'>
      {/* Logo */}
