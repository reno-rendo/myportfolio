...
const projectsData: ProjectType[] = [
  ...
  },
  {
    ...
    repoUrl: null,
    liveUrl: 'https://www.instagram.com/p/DKbWtohh5y3/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
    category: 'UI/UX',
  },
  {
    ...
    repoUrl: null,
    liveUrl: 'https://www.instagram.com/p/DKNSdGGBBlu/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
    category: 'UI/UX',
  },
];
...
const tools: ToolsType[] = [
  ...
  // },
  {
    ...
    id: 'mock-t2',
    imageUrl: '/images/tools/typescript.svg',
    sortOrder: 0,
  },
  {
    label: 'JavaScript',
    ...
    id: 'mock-t3',
    imageUrl: '/images/tools/javascript.svg',
    sortOrder: 0,
  },
  {
    label: 'Tailwind CSS',
    ...
    id: 'mock-t4',
    imageUrl: '/images/tools/tailwindcss.svg',
    sortOrder: 0,
  },
  {
    label: 'Node.js',
    ...
    id: 'mock-t5',
    imageUrl: '/images/tools/nodejs.svg',
    sortOrder: 0,
  },
  {
    label: 'Java',
    ...
    id: 'mock-t6',
    imageUrl: '/images/tools/java.svg',
    sortOrder: 0,
  },
  {
    label: 'spring Boot',
    ...
    id: 'mock-t7',
    imageUrl: '/images/tools/springboot.svg',
    sortOrder: 0,
  },
  {
    label: 'Python',
  ...
  },
  {
    ...
    id: 'mock-t9',
    imageUrl: '/images/tools/expressjs.svg',
    sortOrder: 0,
  },
  {
    label: 'PostgreSQL',
    ...
    id: 'mock-t10',
    imageUrl: '/images/tools/postgres.svg',
    sortOrder: 0,
  },
  {
    label: 'MySQL',
  ...
  },
  {
    ...
    id: 'mock-t16',
    imageUrl: '/images/tools/css3.svg',
    sortOrder: 0,
  },
  {
    label: 'Figma',
    ...
    id: 'mock-t17',
    imageUrl: '/images/tools/figma.svg',
    sortOrder: 0,
  },
  {
    label: 'Next.js',
  ...
  {
    label: 'GraphQL',
    imgSrc: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain.svg',
    id: 'mock-t29',
...
const services: ServiceType[] = [
  {
    ...
    id: 'mock-s1',
    description: 'I build complete features end to end, covering frontend, backend, APIs and deployment. My focus is delivering working functionality that holds up in real use.',
    sortOrder: 0,
    iconName: 'Palette',
  },
  {
    ...
    projectCount: '58 Projects',
    icon: <Globe className='h-6 w-6 text-green-400' />,
    id: 'mock-s2',
    description: 'I implement smooth, consistent user interfaces using React and TypeScript. I care about clean structure, predictable behavior and components that scale with the project.',
    sortOrder: 0,
    iconName: 'Globe',
  },
  {
    ...
    projectCount: '47 Projects',
    icon: <Layers className='h-6 w-6 text-green-400' />,
    id: 'mock-s3',
    description: 'I design clear data models and implement reliable server logic in Java or Node. I create REST APIs that stay easy to maintain and easy for the frontend to consume.',
    sortOrder: 0,
    iconName: 'Layers',
  },
  {
    ...
    id: 'mock-s4',
    description: 'I work with SQL databases, write optimized queries and handle the data layer so the application performs well and stays stable as it grows.',
    sortOrder: 0,
    iconName: 'Smartphone',
  },
...
const certifications: CertificationType[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/tools/postman.svg',
    credentials:
      'https://badges.parchment.com/public/assertions/FNw6FkwfSwWucjgpDXotew',
    imgSrc: '/images/tools/postman.svg',
  },
  {
